...
console.log(bestMovie("Avengers Endgame"))
...
function froggy (gold) {
  let chocoFrog = 3
  let totalFrogs = gold / chocoFrog
  return totalFrogs
}
console.log(froggy(4))
...
//CODE HERE
function froggy2 (gold) {
  let chocoFrog2 = 3
  let totalFrogs2 = Math.floor(gold / chocoFrog2)
  return totalFrogs2
}
console.log(froggy2(4))

////////////////// PROBLEM 21 ////////////////////
let sampleArray = [0,1,2,3,4,7,5,6,8,9]
let otherArray = [0,-1,3,8,2,5]
/*
...
let arrayIsAscending = arr3(sampleArray)
